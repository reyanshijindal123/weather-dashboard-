...
export const getWeatherIcon = (value: string): LucideIcon => {
    ...
    <div className="mt-8 rounded-[40px] bg-white/10 backdrop-blur-2xl border border-white/20 shadow-2xl p-8 text-white hover:scale-[1.02] transition-all duration-300">
      <div className="flex flex-col md:flex-row items-center justify-between">
        <div>
          ...
          <p className="mt-2 text-2xl capitalize">{weather.description}</p>
      ...
      <div className="mt-10 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        ...
        <div className="rounded-2xl bg-white/10 p-4 text-center">
          ...
          <p className="mt-2 text-2xl font-bold">{weather.windSpeed} m/s</p>
        </div>
        ...
        <div className="rounded-2xl bg-white/10 p-4 text-center">
          ...
          <p className="mt-2 text-lg font-bold">{formatTime(weather.sunset)}</p>
        </div>

        <div className="rounded-2xl bg-white/10 p-4 text-center">
          <p className="opacity-70">Pressure</p>

          <p className="mt-2 text-lg font-bold">{weather.pressure} hPa</p>
        </div>
